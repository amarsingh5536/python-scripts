...
data_set = pd.read_csv("/home/amar/Downloads/D4-ipstack.csv")
...
for row in data_set.iterrows():
    ...
    url='http://api.ipstack.com/'+loan_ip+'?access_key=6fda225495b676758c991b1ac353a081'
    ...
    pay_url='http://api.ipstack.com/'+pay_ip+'?access_key=6fda225495b676758c991b1ac353a081'
